...
//MOSTAR MENSAJE DESPUES DE ACTUALIZAR
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        ...
        $response = $usuarioApiClient->cambiarPassword($id_usuario_logueado, $password_actual, $password_nueva, $password_confirmar);
