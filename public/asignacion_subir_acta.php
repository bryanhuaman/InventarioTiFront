...
<div class="card">
    <div class="card-body">
        <form id="subirActaForm" action="asignacion_subir_acta.php?id=<?php echo $id_asignacion; ?>" method="POST" enctype="multipart/form-data">
            <div class="mb-3">
        ...
        <script>
            document.getElementById("subirActaForm").addEventListener("submit", function(event) {
